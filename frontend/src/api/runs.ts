...
export const triggerRun = (projectId: number, triggerType = "manual", headed = false, stepDelay = 0) =>
  post<TestRun>(`/runs?project_id=${projectId}&trigger_type=${triggerType}&headed=${headed}&step_delay=${stepDelay}`);
